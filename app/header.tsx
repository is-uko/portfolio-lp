    ...
    <div>
      ...
      >
        ...
        >
          ...
          <button className="relative px-12 py-3 border-2 border-black after:absolute after:-bottom-2 after:-right-2 after:w-60 after:h-12 after:border-b-2 after:border-r-2 after:border-black hover:bg-black hover:text-red-600 duration-500">無料体験に申し込む</button>
        </nav>
      </div>
